// AI Chat Component for Calendar
const { useState, useEffect, useRef } = React;

function CalendarChat({ clientId, onEventAction }) {
            ...
            setMessages([
                {
                    id: 'welcome',
                    type: 'ai',
                    content: "Hello! I'm your Calendar AI assistant. I can help you with questions about your campaigns or make changes to your calendar. What would you like to know?",
                    timestamp: new Date()
                }
            ]);
            setChatHistory([]);
    ...
    const handleSendMessage = async () => {
        ...
        try {
            // Send to backend
            const response = await axios.post(`${API_BASE_URL}/api/firebase-calendar/chat`, {
                client_id: clientId,
            ...
            const aiMessage = {
                ...
                isAction: response.data.is_action,
            ...
            // If it was an action, trigger refresh
            if (response.data.is_action && onEventAction) {
                onEventAction();
            }
