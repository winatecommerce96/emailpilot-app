...
async def update_calendar_event(event_id: str, event_data: dict):
    """Update an existing calendar event in Firebase - NO AUTH"""
    try:
...
async def delete_calendar_event(event_id: str):
    """Delete a calendar event from Firebase - NO AUTH"""
    try:
...
async def import_from_google_doc(import_data: dict, background_tasks: BackgroundTasks):
    """Import calendar events from Google Doc - NO AUTH"""
    try:
...
async def calendar_chat(chat_data: dict):
    """Chat with AI about calendar events - NO AUTH"""
    try:
...
# Client management endpoints - NO AUTH
@router.get("/clients")
async def get_clients():
    """Get all clients from Firebase - NO AUTH"""
    try:
...
async def create_client(client_data: dict):
    """Create a new client in Firebase - NO AUTH"""
    try:
